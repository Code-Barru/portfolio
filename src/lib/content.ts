 ...
 */
export function searchItems<T extends PostMeta | ProjectMeta>(items: T[], query: string): T[] {
 ...
 */
export function filterByTags<T extends PostMeta | ProjectMeta>(items: T[], tags: string[]): T[] {
