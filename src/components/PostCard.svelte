...
<a
	...
	class="group relative block overflow-hidden rounded-md border border-mocha-surface1 border-t-mocha-surface2 bg-mocha-base shadow-sm shadow-mocha-crust
		...
		<div class="w-full px-5 py-5">
			...
			<div class="flex items-start gap-2">
				...
				<div class="min-w-0 flex-1">
					<div class="line-clamp-3 font-mono text-sm break-words text-mocha-subtext0">
						{post.description}
					</div>
				</div>
			</div>
